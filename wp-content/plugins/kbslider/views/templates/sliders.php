...
?>
	...
	<div>		
		...
		<ul>
			<li>* From the <b>theme html</b> use: <code>&lt?php putKBSlider( id or "alias" ) ?&gt</code> example: <code>&lt?php putKBSlider(<?echo $exampleID?>) ?&gt</code> </li>
			<li>* From the <b>widgets panel</b> drag the "KenBurns Slider" widget to the desired sidebar</li>
