<?php
/*
Name: box post Follow Price 4 Limo
Author: Thanh
Version: 1.0
...
Class: box_post_follow_price_4_limo
*/

class box_post_follow_price_4_limo extends thesis_box {
	protected function translate() {
		global $thesis;
                $this->name = __('box post Follow Price 4 Limo', 'os-rev-thesis');
		$this->title = sprintf(__('box post Follow Price 4 Limo', 'os-rev-thesis'));
...
$my_postid = 70;//This is page id or post id
