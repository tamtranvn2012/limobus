<?php
/*
Name: box post Party Bus Rentals
Author: Thanh
Version: 1.0
...
Class: box_post_party_bus_rentals
*/

class box_post_party_bus_rentals extends thesis_box {
	protected function translate() {
		global $thesis;
                $this->name = __('box post Party Bus Rentals', 'os-rev-thesis');
		$this->title = sprintf(__('box post Party Bus Rentals', 'os-rev-thesis'));
