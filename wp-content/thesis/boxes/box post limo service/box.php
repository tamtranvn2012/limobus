...
Class: box_post_limo_service
*/

class box_post_limo_service extends thesis_box {
	protected function translate() {
		global $thesis;
                $this->name = __('box post limo service', 'os-rev-thesis');
		$this->title = sprintf(__('box post limo service', 'os-rev-thesis'));
...
$my_postid = 51;//This is page id or post id
